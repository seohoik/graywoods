...
author: sh
type: post
date: 2016-04-17T12:18:23+00:00
url: /2016/207/
categories:
  - Apps
tags:
...
---
아이폰이나 아이프드에서 사전 앱을 많이 사용하시나요? 전 이제 학생도 아니고 영어로된 텍스트를 읽을 일도 그렇게 많지 않다보니까 사전을 자주 사용하지는 않습니다. 그래서 이런저런 좋은 사전이 새로 나오거나 가끔 무료로 풀려도 몇 번 사용해보고는 늘 쓰던 사전으로 돌아옵니다. 바로 그 늘 돌아오는 사전이 [Terminology][1]입니다.

<img decoding="async" src="https://www.dropbox.com/s/rsekbl10a3y76h0/IMG_2214.jpeg?raw=1" alt="" /> 

이 앱은 [Drafts][2]를 만든 [Agile Tortoise][3]에서 만든 사전 앱입니다. Drafts를 사용해 봤다면 잘 아시겠지만 이 앱도 url scheme를 기반으로 작동하도록 되어 있어서 이를 지원하는 사전앱이 여러 개 있다면 먼저 찾고 싶은 단어를 쓴 다음에 취향에 맞는 사전을 이것저것 골라서 단어를 검색해 볼 수 있는 장점이 있습니다.
...
과거에 Writeup이라는 앱을 사용할 때는 영업 단어를 선택하면 &#8220;Te: Lookup&#8221; 또는 &#8220;Te: Replace&#8221; 라는 팝업 메뉴가 나와서 룩업을 선택하면 그 단어 뜻만 찾아보고 돌아오고, 리플레이스를 선택하면 터미놀로지에서 찾은 새로운 단어로 교체도 가능했는데, 기능을 제거한 것인지 이를 지원하는 앱이 더 이상 없는 것인지 지금 Editorial이나 Byword로 시도해 보니 작동이 되지 않네요. 이것도 자주 쓰지는 않지만 유용한 기능 중의 하나였습니다.
 ...
 [1]: https://itunes.apple.com/us/app/terminology-3-extensible-dictionary/id687798859?mt=8
 [2]: https://itunes.apple.com/us/app/drafts-4-quickly-capture-notes/id905337691?mt=8
 [3]: http://agiletortoise.com/